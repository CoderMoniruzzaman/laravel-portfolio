...
<div id="site-menu">
    <nav class="nav-menu">
        <ul>
            ...
            <li class="menu-item {{ Request::is('portfolio') || Route::is('workdetails') ? 'active' : '' }}"><a href="{{ url('portfolio') }}">Portfolio</a></li>
            <li class="menu-item {{ Request::is('freelance') ? 'active' : '' }}"><a href="{{ url('freelance') }}">Freelance</a></li>
